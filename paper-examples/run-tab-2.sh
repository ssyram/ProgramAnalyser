...
$program para-estimation-recursive.program -direct -acc 1e-5 -Rp_p:0~1 -Rp_t:0~10 -degree:8
...
$program pedestrian.program -direct -acc 1e-4 -m:60 -degree:10 -solver:SDP
